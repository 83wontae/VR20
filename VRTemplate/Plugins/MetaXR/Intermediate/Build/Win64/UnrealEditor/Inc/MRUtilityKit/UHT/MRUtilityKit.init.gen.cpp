...
void EmptyLinkFunctionForGeneratedCodeMRUtilityKit_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MRUtilityKit()
	{
		if (!Z_Registration_Info_UPackage__Script_MRUtilityKit.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UMRUKSubsystem_OnRoomEntered__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UMRUKSubsystem_OnRoomExited__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_MRUtilityKit(Z_Construct_UPackage__Script_MRUtilityKit, TEXT("/Script/MRUtilityKit"), Z_Registration_Info_UPackage__Script_MRUtilityKit, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x888AD7DF, 0x89212485));
