...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_OculusXRMR_Private_OculusXRMR_State_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FOculusXRTrackedCamera::StaticStruct, Z_Construct_UScriptStruct_FOculusXRTrackedCamera_Statics::NewStructOps, TEXT("OculusXRTrackedCamera"), &Z_Registration_Info_UScriptStruct_OculusXRTrackedCamera, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRTrackedCamera), 2404003764U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXRMR_State, UOculusXRMR_State::StaticClass, TEXT("UOculusXRMR_State"), &Z_Registration_Info_UClass_UOculusXRMR_State, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRMR_State), 3679463678U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_OculusXRMR_Private_OculusXRMR_State_h_3071306028(TEXT("/Script/OculusXRMR"),
	Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_OculusXRMR_Private_OculusXRMR_State_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_OculusXRMR_Private_OculusXRMR_State_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_OculusXRMR_Private_OculusXRMR_State_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_OculusXRMR_Private_OculusXRMR_State_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
