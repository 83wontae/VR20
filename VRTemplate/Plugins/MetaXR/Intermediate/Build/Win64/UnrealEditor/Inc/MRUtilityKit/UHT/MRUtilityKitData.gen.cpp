...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitData_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMRUKLocalizer, AMRUKLocalizer::StaticClass, TEXT("AMRUKLocalizer"), &Z_Registration_Info_UClass_AMRUKLocalizer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMRUKLocalizer), 1590752233U) },
		{ Z_Construct_UClass_UMRUKAnchorData, UMRUKAnchorData::StaticClass, TEXT("UMRUKAnchorData"), &Z_Registration_Info_UClass_UMRUKAnchorData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKAnchorData), 563264201U) },
		{ Z_Construct_UClass_UMRUKRoomData, UMRUKRoomData::StaticClass, TEXT("UMRUKRoomData"), &Z_Registration_Info_UClass_UMRUKRoomData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKRoomData), 2578393832U) },
		{ Z_Construct_UClass_UMRUKSceneData, UMRUKSceneData::StaticClass, TEXT("UMRUKSceneData"), &Z_Registration_Info_UClass_UMRUKSceneData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKSceneData), 1564692234U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitData_h_2891239455(TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_VR20_VRTemplate_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitData_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
